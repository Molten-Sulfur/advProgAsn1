...
var marker1 = L.marker([38.65612871682558, -90.30506101804117], {opacity: 0.8}, {icon: blackCircle}).addTo(map);
...
var marker2 = L.marker([38.59344865082094, -90.2259506603557], {opacity: 0.8}, {icon: blackCircle}).addTo(map);
marker2.bindPopup("<p1><b><a href='https://morningglorydiner.square.site/'>Morning Glory Diner</b></a><br>Best slinger in the city!</p1>");

var marker3 = L.marker([38.62746928042913, -90.33737814862232], {opacity: 0.8}, {icon: blackCircle}).addTo(map);
marker3.bindPopup("<p1><b><a href='https://www.maileestl.com/'>Mai Lee</b></a><br>My wife's favorite Vietnamese joint.</p1>");

var marker4 = L.marker([38.62663719046965, -90.26098196175731], {opacity: 0.8}, {icon: blackCircle}).addTo(map);
...
var marker5 = L.marker([38.60031501305363, -90.24284498768233], {opacity: 0.8}, {icon: blackCircle}).addTo(map);
